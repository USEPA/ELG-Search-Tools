...
module.exports = {
  up: (queryInterface, ignore) => queryInterface.sequelize.query('CREATE VIEW elg_search."ViewDefinition" as ' +
    ...
    "ad.term, regexp_replace(ad.definition, '^\\(Subpart [[:alpha:]]*\\) ', '') as definition, ad.typo_flag_definition " +
  ...
  down: (queryInterface, ignore) => queryInterface.sequelize.query('DROP VIEW elg_search."ViewDefinition"')
};
