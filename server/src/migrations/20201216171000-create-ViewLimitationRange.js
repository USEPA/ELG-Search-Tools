...
module.exports = {
  up: (queryInterface, ignore) => queryInterface.sequelize.query('CREATE VIEW elg_search."ViewLimitationRange" as ' +
  ...
  down: (queryInterface, ignore) => queryInterface.sequelize.query('DROP VIEW elg_search."ViewLimitationRange"')
};
