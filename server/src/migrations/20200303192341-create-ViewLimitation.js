...
module.exports = {
  up: (queryInterface, Sequelize) => queryInterface.sequelize.query('CREATE VIEW elg_search."ViewLimitation" as ' +
    ...
    'wp.processop_description, wp.processop_notes, wp.lim_calc_desc as wp_lim_calc_desc, wp.alternative_requirement, wp.voluntary_requirement, wp.process_addtdetail, ' +
    ...
    'ct.ct_id, ct.ct_code, ct.ct_order, ct.ct_cfr_section, count(lta.ltaid) as lta_count ' +
