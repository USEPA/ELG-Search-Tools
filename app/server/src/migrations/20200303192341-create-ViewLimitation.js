...
module.exports = {
  up: (queryInterface) =>
    queryInterface.sequelize.query(
      'CREATE VIEW elg_search."ViewLimitation" as ' +
        ...
        'wp.processop_id, wp.processop_title, wp.secondary, wp.secondary_parts, wp.sortorder, wp.cfr_sect as wp_cfr_sect, ' +
        ...
        'wp.processop_id, wp.processop_title, wp.secondary, wp.secondary_parts, wp.sortorder, wp.cfr_sect, ' +
  ...
  down: (queryInterface) => queryInterface.sequelize.query('DROP VIEW elg_search."ViewLimitation"'),
};
