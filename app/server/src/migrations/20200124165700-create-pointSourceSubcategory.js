...
module.exports = {
  up: (queryInterface, Sequelize) =>
    queryInterface
      ...
      .then(() => {
        queryInterface
          .addIndex({ schema: 'elg_search', tableName: 'PointSourceSubcategory' }, ['psc_code'])
          .then(() => {
            queryInterface.addIndex({ schema: 'elg_search', tableName: 'PointSourceSubcategory' }, ['subcat_title']);
          });
      }),
