...
module.exports = {
  up: (queryInterface) =>
    queryInterface.sequelize.query(
      'CREATE VIEW elg_search."ViewLongTermAverage" as ' +
        'select lta.lta_value, lu_lta.unit as lta_unit, lu_lta.unit_desc as lta_unit_desc, lu_lta.unit_basis as lta_unit_basis, ' +
        'lta.notes as lta_notes, lta.tech_ref as lta_tech_ref, rs.display_title as lta_source_title, tt.treatment_id, tt.treatment_codes, ' +
  ...
  down: (queryInterface) => queryInterface.sequelize.query('DROP VIEW elg_search."ViewLongTermAverage"'),
};
