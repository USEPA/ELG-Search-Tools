...
module.exports = {
  up: (queryInterface) =>
    queryInterface.sequelize.query(
      'CREATE VIEW elg_search."ViewWastestreamProcessTreatmentTechnologyPollutantLimitation" as ' +
  ...
  down: (queryInterface) =>
    queryInterface.sequelize.query(
      'DROP VIEW elg_search."ViewWastestreamProcessTreatmentTechnologyPollutantLimitation"'
    ),
};
